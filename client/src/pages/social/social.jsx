        ...
        <TechSection>
          <InfoContainer>
            ...
            <StyledSmallSubTitle maxWidth="70rem" textAlign="center">
              ...
              descobrir como me conecto com outros desenvolvedores e compartilho
              minha jornada.{" "}
          ...
          >
            <div className="handleMessage">
              ...
              <StyledSmallSubTitle width="85%">
                No Instagram, utilizo a plataforma para mesclar entretenimento e
                aprendizado, postando dicas rápidas, memes sobre o dia a dia da
                programação e desafios que enfrento. Essa abordagem leve ajuda a
                conectar com outros desenvolvedores, sejam novatos ou
                experientes, tornando o processo de aprendizado mais divertido.
              </StyledSmallSubTitle>
            </div>
            <FaInstagram />
          </ExperienceContainer>
          ...
          >
            <div className="handleMessage">
              ...
              <StyledSmallSubTitle width="88%">
                ...
                sobre projetos em que estou trabalhando e novas habilidades que
                adquiri. Ao mostrar minha trajetória, espero inspirar outros e
                fortalecer minha presença na comunidade de desenvolvimento.
                divertido.
              </StyledSmallSubTitle>
            </div>
            <FaLinkedin />
          ...
          >
            <div className="handleMessage">
              ...
              <StyledSmallSubTitle width="88%">
                ...
                desenvolvi, permitindo que outros vejam meu estilo de trabalho e
                aprendam comigo. Ao mostrar minha trajetória através dos
